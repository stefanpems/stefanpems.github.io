...
Alternatively, without doing the two "joins" operations in the query just shown above, it is possible to retrieve the name of the calling managed identity or application by parsing the content of the field "identity_claim_xms_mirid_s". This field has a content similar to this example:

**Example of content for "identity_claim_xms_mirid_s":** /subscriptions/<<subscription-id>>/resourcegroups/<<rg-name>>/providers/Microsoft.Storage/storageAccounts/staccsecuritylabwe001
{: .notice}
